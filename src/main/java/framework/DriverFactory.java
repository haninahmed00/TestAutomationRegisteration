...
public class DriverFactory {
    ...
    public static WebDriver initiateDriver(String browserType, int implicitWait, Boolean maximize, Boolean headless) {
    ...
    public static WebDriver initiateDriver(String browserType) {
        return initiateDriver(browserType, 20, true, false);
    }
